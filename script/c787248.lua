-- Kamohoali'i, the Carcharrack of the North Seas
local s,id,o=GetID()
...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	-- Cannot Summon Monsters from the Extra Deck
	...
	c:RegisterEffect(e3)
	-- Banish a monster from SS from the hand or Extra
...
function s.cfilter(c,tp)
	return c:IsAbleToRemove() and c:IsControler(1-tp) and (c:IsSummonLocation(LOCATION_HAND) or c:IsSummonLocation(LOCATION_EXTRA))
end
