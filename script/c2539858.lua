...
--e2 Effect Code
function s.filter(c)
	return c:IsCanChangePosition() or (not c:IsCanChangePosition() and c:IsAbleToHand())
end
...
function s.operat(e,tp,eg,ep,ev,re,r,rp)
	...
	elseif not tc:IsCanChangePosition() and tc:IsAbleToHand() then
