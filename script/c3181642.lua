...
function s.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e1:SetTarget(function(_,c) return c:IsLevelAbove(5) and c:IsAttribute(ATTRIBUTE_LIGHT) and c:IsLocation(LOCATION_HAND) end)
	...
	e2:SetTarget(function(_,c) return c:IsLevelAbove(5) and c:IsAttribute(ATTRIBUTE_LIGHT) and c:IsLocation(LOCATION_HAND) end)
...
function s.filter(c)
	return c:IsSetCard(0xc77) and c:IsType(TYPE_SPELL) and c:IsAbleToHand()
end
